...
do
    ...
    echo "Username: capuser$i@$2, Password: Pa55w0rd$i" >> access.txt
done
sp=$(az ad sp create-for-rbac --name "capuser-github-actions-sp" --sdk-auth --role contributor --scopes /subscriptions/$1)
echo "Service Principal: $sp" >> access.txt